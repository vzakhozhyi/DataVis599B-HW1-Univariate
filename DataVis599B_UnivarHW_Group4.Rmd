...
```{r barplot}
cols <- ifelse(ft_freq_df_ord$faretype == "Cash", "red","steelblue")
...
ft_plot2 = ft_plot1 + labs(title='Do riders still use cash to pay a transit fare in Seattle?',
                           ...
                           caption = 'Source: Seattle Sound Transit Data, Oct-Nov 2015')
...
ft_plot4 = ft_plot3 + geom_text(aes(y = pct,
                                ...
                                hjust= -0.15, 
                                size = 3)
ft_plot5 = ft_plot4 + theme(panel.background = element_rect(fill = "grey95", color = "black"),
